...
<head>
<meta charset="utf-8">
<title>海角七号餐厅登录界面</title>
<link rel="stylesheet" href="ul/lib/layui/css/layui.css" media="all" />
<link rel="stylesheet" href="ul/css/login.css" />
<link rel="stylesheet" href="ul/css/tooltips.css" />


<script type="text/javascript" src="ul/js/jquery.min.js"></script>
<script type="text/javascript" src="ul/js/jquery.pure.tooltips.js"></script>
<script type="text/javascript" src="ul/lib/layui/layui.js"></script>
<style>
body {
	margin:0;
	padding:0;
...
.box-login{width:450px; height:350px;margin-top:-10%;top:50%;}
.box-register{width:450px; height:530px;margin-top:-20%;top:46%;}
...
<div class="beg-login-box box box-login layui-anim-up" id="login">
	...
	<div class="beg-login-main">
		<form action="dologin" class="layui-form" method="post"><input name="__RequestVerificationToken" type="hidden" value="fkfh8D89BFqTdrE2iiSdG_L781RSRtdWOH411poVUWhxzA5MzI8es07g6KPYQh9Log-xf84pIR2RIAEkOokZL3Ee3UKmX0Jc8bW8jOdhqo81" />		
			<div class="layui-form-item">
				<label class="beg-login-icon">
				<i class="layui-icon">&#xe612;</i>
			</label>
			     <span id="tip1"  style="color:white">${flag1}</span>
			...
			<input type="radio"  value="user" name="usertype"  checked>
					<span  style="color:white">用户</span>  <br>
			...
			<div class="layui-form-item">
				...
				<div class="beg-pull-right">
					<input type="submit"  value="登录" class="layui-btn layui-btn-radius" style="margin-top: 4%;" onclick="return login()" >
					<i class="layui-icon">&#xe650;</i> 
...
<div class="beg-login-box box box-register layui-anim-rotate" id="register">
	...
	<div class="beg-login-main">
		<form action="doreg" class="layui-form" method="post">
			<div class="layui-form-item">
				<label class="beg-login-icon">
				<i class="layui-icon">&#xe612;</i>
			</label>
				<input id="username_register"  type="text" Name="Username"  autocomplete="off" placeholder="请输入用户名" class="layui-input"  onchange="chkName()"><span id="tip"  style="color:white"></span>
			</div>
			<div class="layui-form-item">
				<label class="beg-login-icon">
					<i class="layui-icon">&#xe642;</i>
			...
			<div class="layui-form-item">
				...
				<input id="determine_password_register" type="password" Name="Password1" lay-verify="password" autocomplete="off" placeholder="确认密码" class="layui-input">
			</div>
			<div class="layui-form-item">
				<label class="beg-login-icon">
					<i class="layui-icon">&#xe642;</i>
				</label>
				<input id="determine_password_register" type="text" Name="Name" lay-verify="password" autocomplete="off" placeholder="请输入姓名" class="layui-input">
			</div>
			<div class="layui-form-item">
				<label class="beg-login-icon">
					<i class="layui-icon">&#xe642;</i>
				</label>
				<input id="determine_password_register" type="text" Name="Phone" lay-verify="password" autocomplete="off" placeholder="请输入手机" class="layui-input">
			</div>
			<div class="layui-form-item">
				<label class="beg-login-icon">
					<i class="layui-icon">&#xe642;</i>
				</label>
				<input id="determine_password_register" type="text" Name="Sex" lay-verify="password" autocomplete="off" placeholder="请输入性别" class="layui-input">
			</div>
			<div class="layui-form-item">
				<label class="beg-login-icon">
					<i class="layui-icon">&#xe642;</i>
				</label>
				<input id="determine_password_register" type="text" Name="IdNumber"  lay-verify="password" autocomplete="off" placeholder="请输入身份证号" class="layui-input">
			</div>
			
			<div class="layui-form-item">
				<div class="beg-pull-left beg-login-remember" style="color:#FFFFFF;margin-top: 6%;">
					<input  type="submit"  value="注册"class="layui-btn"  onclick="return register()">
