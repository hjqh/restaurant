        ...
        <div class="page-header-inner ">
            ...
            <div class="page-logo">
                <a href="index1">
                    ...
                    <span class="logo-default">海角七号</span> </a>
            </div>
            <!-- logo end -->
            ...
            <div class="page-content">
                <div class="page-bar">
                    <div class="page-title-breadcrumb">
                        <div class=" pull-left">
                            <div class="page-title">外卖待处理信息</div>
                        </div>
                                ...
                                <div class="row p-b-20">
                                    ...
                                    <div class="table-scrollable">
                                        <table class="table table-hover table-checkable order-column full-width"
                                            ...
                                            <tbody>
                                            <c:forEach var="deal_out_food" items="${deal_out_food }">
                                                <tr>
                                                    
                                                    <td class="center"><a
                                                            href=""></a>${deal_out_food.id }</td>
                                                    <td class="center">${deal_out_food.user.name }</td>
                                                    <td class="center">${deal_out_food.user.phone }</td>
                                                   <td class="center">${deal_out_food.address.detail }</td>
                                                   <td class="center">${deal_out_food.order_time }</td>
                                                   <td class="center">${deal_out_food.remark}</td>
                                                   <td class="center">${deal_out_food.food.fname}</td>
                                                     <td class="center">${deal_out_food.nums}</td>
                                                    <td class="center">${deal_out_food.total }</td>
                                                    <td class="center">${deal_out_food.state }</td>
    
                                                    <td class="center">
                                                     <a href="insure?id=${deal_out_food.id } ">确认订单</a>	
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                            </tbody>
