		...
		<div class="page-container">
						...
						<ul class="sidemenu page-header-fixed p-t-20"
							...
							<li class="nav-item"><a href="#" class="nav-link nav-toggle">
								...
								<ul class="sub-menu ">
									...
									<li class="nav-item"><a href="address_add1"
							...
							<li class="nav-item   active"><a href="#"
								...
								<ul class="sub-menu ">
									...
									<li class="nav-item active"><a href="user_imf1"
			...
			<div class="page-content-wrapper">
				<div class="page-content">
					...
					<div class="row">
						<div class="col-md-12">
							<form name="add" action="doUserImf" method="post">
								
								<div class="col-lg-12 p-t-20">
									<div
										class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										<input class="mdl-textfield__input" type="text" id="name"
											name="name" value="${userImf.getName() }"> <label class="mdl-textfield__label">姓名</label>
										<!--  <span id="tip"></span>-->
									</div>
								</div>
								...
								<div class="col-lg-12 p-t-20">
											<div
												...
												<input class="mdl-textfield__input" type="text"
													id="phone" name="phone" value="${userImf.getPhone() }"> <label
													class="mdl-textfield__label">电话</label>
												<!--  <span id="tip"></span>-->
											</div>
										</div>
								...
								<div class="col-lg-12 p-t-20">
											<div
												class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
												<input class="mdl-textfield__input" type="text"
													id="id_number" name="id_number" value="${userImf.getId_number() }"> <label
													class="mdl-textfield__label">身份证号</label>
												<!--  <span id="tip"></span>-->
											</div>
										</div>
								...
								<div class="col-lg-12 p-t-20">
									<div
										...
										<input class="mdl-textfield__input" type="text" id="sex"
											value="${userImf.getSex() }" readonly tabIndex="-1" name="sex"> <label
										...
										<ul data-mdl-for="sex"
											...
											<li class="mdl-menu__item" data-val="男">男</li>
											<li class="mdl-menu__item" data-val="女">女</li>
