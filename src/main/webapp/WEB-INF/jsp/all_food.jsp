            ...
            <div class="page-content">
                <div class="page-bar">
                    <div class="page-title-breadcrumb">
                        <div class=" pull-left">
                            <div class="page-title">全部菜品信息</div>
                        </div>
                            ...
                            <div class="card-body ">
                                <div class="row p-b-20">
                                    <div class="col-md-6 col-sm-6 col-6">
                                        <div class="btn-group">
                                            <a href="/food_add.jsp" id="addRow" class="btn btn-info">
                                                添加菜品 <i class="fa fa-plus"></i>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="table-scrollable">
                                        <table class="table table-hover table-checkable order-column full-width"
                                            ...
                                            <c:forEach var="findfood" items="${findfood }">
                                                <tr>
                                                    <td class="center"><img src="food/${findfood.imgpath }" width="120" height="90"></td>
                                                    <td class="center">${findfood.fname }</td>
                                                    
                                                    <td class="center">${findfood.price }</td>
                                                    <td class="center"><a href="dofindFoodById?id=${findfood.id }">修改菜名和价格</a></td>
                                                    <td class="center"><a href="doFoodDel?id=${findfood.id }">删除</a></td>
                                                </tr>
                                            </c:forEach>
                                            </tbody>
                                            </thead>
